...
$( document ).ready(function() {
    ...
    // $("#identity_proof_with_same_address_yes").click(function(){
    //     $("#owner_id_proof_different_address").prop('disabled',false);
    // });
    // $("#identity_proof_with_same_address_no").click(function(){
    ...
    /*$("input[name='property_type']").click(function(){
        ...
        if(property_type == 1){
            $("#pg_description").css('display','none');
            $("#flat_description").css('display','block');
        }else if(property_type == 2){
            $("#pg_description").css('display','block');
            $("#flat_description").css('display','none');
        }
    });
    var property_type = $("input[name='property_type']:checked").val();
    if(property_type == 1){
    ...
    $("#add_more_additional").click(function(){
        ...
        if(additional_information_count < 5){
            ...
            var html = '<div class="form-group row"><div class="col-md-10"><input class="form-control" id="additional_information" type="text" name="additional_information[]" placeholder="Enter additional Information" value=""></div><div><button class="btn btn-primary-custom remove_button" id="remove_button" type="button">Remove</button></div></div>';

            $("#card_additional").append(html);
        }
