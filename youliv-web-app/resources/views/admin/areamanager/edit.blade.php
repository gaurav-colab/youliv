                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="ownerForm" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="name" type="text" name="name" placeholder="Enter name" value="{{old('name',$areamanager_detail->name ?? '')}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span class="required">*</span>
                                            <input class="form-control" id="phone" type="number" name="phone" minlength = "10" placeholder="Enter Contact Number" value="{{old('phone',$areamanager_detail->phone ?? '')}}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10">
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<span class="required">*</span>
									<input class="form-control" id="email" type="email" name="email" placeholder="Enter Email Address" value="{{old('email',$areamanager_detail->email ?? '')}}">
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<span class="required">*</span>
									<input class="form-control" id="emp_code" type="text" name="emp_code" placeholder="Enter Employee Code" value="{{old('emp_code',$areamanager_detail->emp_code ?? '')}}">
								 ...
								 <div class="col-md-6">
									...
									<span class="required">*</span>
									<input class="form-control" id="doj" type="date" name="doj" placeholder="Enter Date Of Joining" value="{{old('doj',$areamanager_detail->doj  ?? '')}}">
								...
								<div class="col-md-6">
									...
									<span class="required">*</span>
									<textarea class="form-control" id="p_address"  name="p_address" placeholder="Enter Permanent Address" value="">{{old('p_address',$areamanager_detail->p_address  ?? '')}}</textarea>
								 ...
								 <div class="col-md-6">
									...
									<span class="required">*</span>
									<textarea class="form-control" id="c_address"  name="c_address" placeholder="Enter Current Address">{{old('c_address',$areamanager_detail->c_address  ?? '')}}</textarea>
