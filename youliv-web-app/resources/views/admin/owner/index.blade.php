...
<div class="container-fluid">
            <div class="fade-in">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Property Owner List
                        <div class="col-6 col-sm-4 col-md-3  mb-3 mb-xl-0" style="float:right;">
                            <button class="btn btn-block btn-primary-custom" type="button"><a style="color:#fff" href="add_propery_owner">Add Property Owner</a></button>
                        </div>
                    </div>
					   ...
					   @if($owner_detail)
						...
						<tr>
						 <td>{{$value->owner_name}}</td>
						  ...
						  <td><a href="{{url('/admin/property_list/')}}?type=owner&id={{$value->id}}">View Property</a></td>
						  <td>
						  <span class="bank-edit ml-3">
						  	
							<a href="{{url('/admin')}}/owner_detail/{{$value->id}}" class="view_link"><i class="fa fa-eye" title="View"></i></a>
							
							</span>
							<span class="bank-edit ml-3">
							<span title="Edit" data-action="edit" data-id="{{$value->id}}" data-url="{{url('/admin')}}" data-type="property_owner">
							<i class="fa fa-pencil-alt edit_link" title="Edit"></i>
							</span>
							</span>
							<span class="bank-delete ml-3">
							<span title="Delete" data-action="delete" data-id="{{$value->id}}" data-url="{{url('/admin')}}" data-type="property_owner">
