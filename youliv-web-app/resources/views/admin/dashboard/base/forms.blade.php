                          ...
                          <div class="col-md-12">
                            <div class="input-group">
                              ...
                              <div class="input-group-append"><span class="input-group-text">
                                  <svg class="c-icon">
                                    <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-envelope-open"></use>
                                  </svg></span></div>
                            </div>
                          </div>
                        </div>
                        <div class="form-group row">
                          <div class="col-md-12">
                            <div class="input-group">
                              <div class="input-group-prepend"><span class="input-group-text">
                                  <svg class="c-icon">
                                    <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-euro"></use>
                                  </svg></span></div>
                          ...
                          <div class="col-md-12">
                            <div class="input-group"><span class="input-group-prepend">
                                <button class="btn btn-primary" type="button">
                                  <svg class="c-icon">
                                    <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-magnifying-glass"></use>
                                  </svg> Search
                                </button></span>
                      ...
                      <form action="" method="post">
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <div class="input-group-append"><span class="input-group-text">
                                <svg class="c-icon">
                                  <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-lock-locked"></use>
                                </svg></span></div>
                          </div>
                        </div>
