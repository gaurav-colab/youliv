...
<html lang="en">
  <head>
    ...
    <link rel="manifest" href="../admin/public/assets/favicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="{{ url ('public/app_asset/images/youliv_favicon2.png') }}">
    ...
    <link href="{{ asset('public/admin/css/coreui-chartjs.css') }}" rel="stylesheet">
