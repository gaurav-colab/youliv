        ...
        <div class="bs-example">
            ...
            <!-- /Start General Owner Details-->
                <div class="card">
                    ...
                    <div id="collapseOne" >
                        <div class="card-body">
                            <form class="form-horizontal" id="ownerForm" enctype="multipart/form-data" method="POST" action="{{url('/admin/')}}/sector/{{$id ?? ''}}/add">
                                @csrf
								<div class="col-md-12">
								@if (session('success'))
								...
								<div class="form-group row">
									<div class="col-md-6">
										...
										<span class="required">*</span>
										<input class="form-control" id="slug" type="text" name="slug" placeholder="Enter slug" value="{{old('slug')}}">
