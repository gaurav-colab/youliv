    ...
    function renderDropdownForMenuEdit($data, $role){
        if(array_key_exists('slug', $data) && $data['slug'] === 'dropdown'){
            ...
            if($data['hasIcon'] === true && $data['iconType'] === 'coreui'){
                echo '<svg class="c-nav-icon edit-menu-icon"><use xlink:href="/public/assets/icons/coreui/free-symbol-defs.svg#' . $data['icon'] . '"></use></svg>';    
                            ...
                            <td>
                                @if($menuel['hasIcon'] === true)
                                    ...
                                    <svg class="c-nav-icon edit-menu-icon">
                                        <use xlink:href="/public/assets/icons/coreui/free-symbol-defs.svg#{{ $menuel['icon'] }}"></use>
                                    </svg> 
