...
?>
      ...
      <div class="c-sidebar-brand">
          <img class="c-sidebar-brand-full" src="{{ url('/public/assets/brand/youliv_logo.png') }}" width="200"  alt="Youliv">
          <img class="c-sidebar-brand-minimized" src="{{ url ('app_asset/images/youliv_favicon2.png') }}" width="50" height="50" alt="Youliv"></div>
        ...
        <li class="c-sidebar-nav-item">
            ...
            <a class="c-sidebar-nav-link" href="{{url('property_owner/property_list')}}">
		...
		<li class="c-sidebar-nav-item">
            ...
            <a class="c-sidebar-nav-link" href="{{url('property_listing_request')}}">
                ...
                Property Add Request
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{url('property_owner/change_password')}}">
                <i class="cil-lock-locked c-sidebar-nav-icon"></i>
                Change Password
            </a>
        </li>

        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{url('property_owner/payment_detail')}}">
        ...
        <li class="c-sidebar-nav-item">
           ...
           <!-- <a class="c-sidebar-nav-linkff" href="">-->
           <span class="c-sidebar-nav-link">
                <i class=" cil-account-logout c-sidebar-nav-icon"></i>
                <form action="{{url('property_owner/logout')}}" method="POST"> @csrf <button type="submit" class="btn btn-ghost-dark btn-block" style="color:white;padding:0px;">Logout</button></form>
            <!--</a>   -->
            <span>
        </li>
        </ul>
