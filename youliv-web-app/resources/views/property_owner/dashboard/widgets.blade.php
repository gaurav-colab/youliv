                  ...
                  <div class="card">
                    <div class="card-body p-3 d-flex align-items-center">
                      <div class="bg-info p-3 mr-3">
                        <svg class="c-icon c-icon-xl">
                          <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-laptop"></use>
                        </svg>
                      </div>
                      <div>
                  ...
                  <div class="card">
                    <div class="card-body p-3 d-flex align-items-center">
                      <div class="bg-warning p-3 mr-3">
                        <svg class="c-icon c-icon-xl">
                          <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-moon"></use>
                        </svg>
                      </div>
                      <div>
                ...
                <div class="col-6 col-lg-3">
                  <div class="card">
                    ...
                    <div class="card-footer px-3 py-2"><a class="btn-block text-muted d-flex justify-content-between align-items-center" href="#"><span class="small font-weight-bold">View More</span>
                        <svg class="c-icon">
                          <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-chevron-right"></use>
                        </svg></a></div>
                  </div>
                </div>
                <!-- /.col-->
              ...
              <div class="card-group mb-4">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="text-muted text-right mb-4">
                      <svg class="c-icon c-icon-2xl">
                        <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-user-follow"></use>
                      </svg>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="text-muted text-right mb-4">
                      <svg class="c-icon c-icon-2xl">
                        <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-basket"></use>
                      </svg>
                    </div>
                ...
                <div class="col-sm-6 col-md-2">
                  <div class="card">
                    <div class="card-body">
                      <div class="text-muted text-right mb-4">
                        <svg class="c-icon c-icon-2xl">
                          <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-speech"></use>
                        </svg>
                      </div>
