                  ...
                  <div class="card">
                    <div class="card-header">Card actions
                      <div class="card-header-actions"><a class="card-header-action btn-setting" href="#">
                          ...
                          <svg class="c-icon">
                            <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-arrow-circle-top"></use>
                          </svg></a><a class="card-header-action btn-close" href="#">
                          <svg class="c-icon">
                            <use xlink:href="public/assets/icons/coreui/free-symbol-defs.svg#cui-x-circle"></use>
                          </svg></a></div>
                    </div>
