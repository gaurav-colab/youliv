                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="pro-leased-det">
                                        ...
                                        <img src="{{ url('')}}/{{$server_path}}{{$propertyData->property_owners->lease_deed}}" alt="address proof">
                                        </figure>
                                        </div>
                                </div>
				...
				@else
					...
					<div class="col-md-12 ">
							<div class="proof-front" data-toggle="modal" data-target="#diff-proof-modal">
							    <img src="{{url('')}}/{{$server_path}}{{ $propertyData->property_owners->property_address_img }}" alt="proof front">
							</div>
					</div>					
					@endif
				@endif
					...
					<div class="card-body">
						...
						<div class="adhar-div">
						   @if($property_owner_id_front!="" || $property_owner_id_back!="") <h6>Identity Proof</h6>@endif
							...
							<div class="proof-front" data-toggle="modal" data-target="#proof-front-modal">
							    <img src="{{url('')}}/{{$server_path}}{{ $property_owner_id_front }}" alt="proof front">
							</div>
							@endif
							@if($property_owner_id_back!="")
							<div class="proof-back" data-toggle="modal" data-target="#proof-back-modal">
							    <img src="{{url('')}}/{{$server_path}}{{ $property_owner_id_back }}" alt="proof back">
							</div>
							@endif
						</div>
                        ...
                        @if($propertyData->id_proof_is_same_address == 2)
                            <div class="adhar-div different-proof">
                                ...
                                <img src="{{ url('')}}/{{$server_path}}{{$propertyData->property_owners->property_address_img}}" alt="">
                                </div>
                            </div>
                        @endif
								</div>
				    ...
				    <div class="card-body">
				        <div class="flat-type">
							...
							{{_('Flat/PG')}}
							 ...
							 <strong>Inventory & Price management  (<a href="{{url('property_owner/edit_inventory')}}/{{$propertyData->property_code}}" >Edit</a>)</strong>
		        ...
		        <div class="card">
				    ...
				    <div class="card-body amen-sec">
						...
						@if(isset($amenities) && count($amenities)>0)
							...
							<div class="colpropertyData-md-2 col-sm-2">
								<figure>
									<img src="{{url('')}}/{{$server_path}}app_asset/images/others.png" alt="">
								</figure>
								<figcaption>
			    ...
			    <div class="card">
					...
					@if(isset($propertyData->property_digital_signature))
                        <figure data-toggle="modal" data-target="#digil-sign-Modal">
                            <img id="digital-sign" src="{{url('')}}/{{$server_path}}{{ $propertyData->property_digital_signature->digital_signature }}" alt="digital Signature" width=300>
                        </figure>
					@else							
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  @if(isset($propertyData->property_owners))
       	...
       	<img src="{{ url('') }}/{{$server_path}}{{$propertyData->property_owners->lease_deed}}" alt="address proof" style="width:450px;height:auto">
		@else							
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	    @if($property_owner_id_front!="")
		   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <img src="{{ url('')}}/{{$server_path}}{{ $property_owner_id_front }}" alt="proof front" style="width:450px;height:auto">
      </div>
	  @else							
...
<div class="modal fade" id="proof-back-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  @if($property_owner_id_back!="")
		   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <img src="{{ url('')}}/{{$server_path}}{{ $property_owner_id_back }}" alt="proof back" style="width:450px;height:auto">
		@else							
...
<div class="modal fade" id="diff-proof-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  @if(isset($propertyData->property_owners))
		   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <img src="{{ url('')}}/{{$server_path}}{{ $propertyData->property_owners->property_address_img }}" alt="proof" style="width:450px;height:auto">
		@else							
...
<div class="modal fade" id="digil-sign-Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  @if(isset($propertyData->property_digital_signature))
		   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <img id="digital-sign" src="{{url('')}}/{{$server_path}}{{ $propertyData->property_digital_signature->digital_signature }}" alt="digital Signature" style="width:450px;height:auto">
		  @else							
