...
@php
    $ownerName  =   ( Auth::guard('property_owner')->user() ) ? Auth::guard('property_owner')->user()->owner_name:'';
...
<div class="container-fluid">
    <div class="fade-in">
        <form class="form-horizontal" id="payment_methods" action="{{route('property_owner.property.payment_detail')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class=" row">
                                <div class="col-md-6">
                                    <select class="form-control" id="select_payment" name="select_payment">
                                        ...
                                        <option value="1" {{ old('select_payment')== 1 ? 'selected' : ''  }}>Bank Transfer</option>
                                        <option value="2" {{ old('select_payment')== 2 ? 'selected' : ''  }}>UPI</option>
        ...
        <div class="row" id='bank_div'>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong><span class="payment_type"></span> details(Owner)</strong>
                    </div>
                    ...
                    <div class="card-body general-card">
                        <div class=" row">
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <p class="alert alert-danger" id ="name_match"  value="nomatch">It seems account holder name dosen't match with property owner name.Please attach authority letter.</p>
                                ...
                                <input type="hidden" id="property_ownerName" value="{{$ownerName}}">
                            </div>
                            ...
                            <div class="col-md-12 mt-3" id="authority_file">
                                ...
                                <input type="file" name="authority_file" class="authority_file" value="{{old('authority_file')}}">
                        ...
                        <div class="row">
                             <div class="col-md-12 mt-3"> @if(isset($owner_pay->approved) && $owner_pay->approved==1) Approved @else Unapproved @endif  </div>
						...
						@if( isset($owner_pay->authority_file) && $owner_pay->authority_file!="")
						<div class="row"> 
