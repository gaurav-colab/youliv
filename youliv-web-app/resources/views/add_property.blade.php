                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" id="areaManagerForm" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 mt-3">												
                                                <button id="submit-all" class="btn btn-primary-custom" type="submit">Submit</button>
												<button disabled type="button"  id="headingZeroclick" class="btn btn-primary-custom" data-toggle="collapse" data-target="#collapseZero">Next</button>
                    ...
                    <!-- /End Property Acknowledgement Details-->
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button disabled type="button" id="headingthreeclick1" style="float:left;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree"><i class="fa fa-angle-right"></i>Property Owned / Property Leased</button>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" id="propertyAddressForm" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <button id="submit-all" class="btn btn-primary-custom" type="submit">Submit</button>
											<button disabled  type="button"  id="headingSixclick" class="btn btn-primary-custom" data-toggle="collapse" data-target="#collapseSix">Next</button>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingSix">
                                <h2 class="mb-0">
                                    <button type="button" disabled id="headingSixclick1" style="float:left;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix"><i class="fa fa-angle-right"></i>Amenities / Additional Information</button>
                            ...
                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                                <div class="card-body" id="card_additional">
                                    <form class="form-horizontal" id="propertyAmenitiesForm" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10 add_info">
                                                <input class="form-control" style="margin-bottom:10px;" id="additional_information" type="text" name="additional_information[]" placeholder="Enter additional Information" value="{{old('informadditional_informationation')}}">
                                            </div>
                                            <div>
                                                <button class="btn btn-primary-custom" id="add_more_additional" type="button">Add more</button>
                                            </div>
                                        </div>
        ...
        $("div#my-awesome-dropzone").dropzone({
            ...
            init: function() {
                ...
                this.on("successmultiple", function(files, response) {
                    ...
                    jQuery('#imagesArray').val(imagesArray);
...
$('#digitalsignatureForm').on('submit',function(event){
		...
		{*/
			...
			$.ajax({
				...
				success:function(data){
					...
					$('#property_owners_id').val(data.propertyId);
				},
			});
		/*}*/    });
    ...
    $('#propertyAddressForm').on('submit',function(event){
        event.preventDefault();
		flag=false;
		if($('#address_house').val()=="" || $('#address_building').val()=="" || $('#address_street').val()=="" || $('#address_state').val()=="" || $('#address_city').val()==""  || $('#address_sector').val()==""  || $('#zipcode').val()==""   || $('#pac-input').val()==""){
